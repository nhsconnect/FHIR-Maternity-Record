---
title: Problems list Problem List
keywords:  list
tags: [fhir]
sidebar: foundations_sidebar
permalink: explore_problems_list.html
summary: "The FHIR profiles used for the Problems list Problem List"
---
...
|Date/time|[Condition](explore_problems_list.html#mapping-for-problems-list-condition)|assertedDate|
|ODS/ORD Site Code|[Location](explore_problems_list.html#mapping-for-problems-list-location)|identifier|
|SDS Job Role Name|[PractitionerRole](explore_problems_list.html#mapping-for-problems-list-practitionerrole)|code|
|Performing professional|[Practitioner](explore_problems_list.html#mapping-for-problems-list-practitioner)|name|
|Condition|[Condition](explore_problems_list.html#mapping-for-problems-list-condition)|code|
|Condition onset date|[Condition](explore_problems_list.html#mapping-for-problems-list-condition)|onsetDateTime|
|Condition end date|[Condition](explore_problems_list.html#mapping-for-problems-list-condition)|abatementDateTime|
|Fetal diagnosis|[Observation](explore_problems_list.html#mapping-for-problems-list-observation)|description| 
|Comment|[Condition](explore_problems_list.html#mapping-for-problems-list-condition)|note| 


## Mapping for Problems list Problem List ##  


|>|Level 1|[List Resource](http://hl7.org/fhir/stu3/list.html)|>|Level 2|[CareConnect-ProblemList-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-ProblemList-1)|>|Level 3|None|  

|**View Used FHIR Elements**|**[View All FHIR Elements](explore_problems_list_all.html#mapping-for-problems-list-problem-list)**| 
...
|  - meta | 0..1 | Mandatory | [Meta](http://hl7.org/fhir/stu3/resource.html#Meta "Meta") | Metadata about the resource<br/><font color='red'>The value attribute of the profile element MUST contain the value 'https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-ProblemList-1'</font> |
|  - extension (clinicalSetting) | 1..1 | Mandatory | [Extension-CareConnect-ClinicalSetting-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/Extension-CareConnect-ClinicalSetting-1 "Extension-CareConnect-ClinicalSetting-1") | To record the clinical setting of a problem list<br/>Constraint (ext-1): Must have either extensions or value[x], not both<br/> |
|  - identifier | 0..* | Required | [Identifier](http://hl7.org/fhir/stu3/datatypes.html#identifier "Identifier") | Business identifier<br/><font color='red'>An identifier for this Problems list</font><br/> |
...
|  - - value | 1..1 | Mandatory | [String](http://hl7.org/fhir/stu3/datatypes.html#string "String") | The value that is unique<br/>Business identifier<br/><font color='red'>A value for the identifier for this Problems list</font> |
...
|  - code | 1..1 | Mandatory | [CodeableConcept](http://hl7.org/fhir/stu3/datatypes.html#codeableconcept "CodeableConcept") | What the purpose of this list is<br/>Binding (example): What the purpose of this list is [http://hl7.org/fhir/stu3/valueset-list-example-codes.html](http://hl7.org/fhir/stu3/valueset-list-example-codes.html) <br/> |
|  - - coding | 1..1 | Mandatory | [Coding](http://hl7.org/fhir/stu3/datatypes.html#coding "Coding") | Code defined by a terminology system<br/> |
|  - - - system | 1..1 | Mandatory | [Uri](http://hl7.org/fhir/stu3/datatypes.html#uri "Uri") | Identity of the terminology system<br/>Fixed Value: [http://hl7.org/fhir/list-example-use-codes](http://hl7.org/fhir/list-example-use-codes)<br/> |
|  - - - code | 1..1 | Mandatory | [Code](http://hl7.org/fhir/stu3/datatypes.html#code "Code") | Symbol in syntax defined by the system<br/>Fixed Value: problems |
|  - - - display | 1..1 | Mandatory | [String](http://hl7.org/fhir/stu3/datatypes.html#string "String") | Representation defined by the system<br/>Fixed Value: Problem List |
|  - subject | 0..1 | Mandatory | [Reference](http://hl7.org/fhir/stu3/references.html "Reference") | If all resources have the same subject<br/>Constraint (ref-1): SHALL have a contained resource if a local reference is provided<br/><font color='red'>This is a reference to the Patient who is the subject of the list.</font> |
|   |  | Mandatory | [CareConnect-Patient-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Patient-1 "CareConnect-Patient-1") | <font color='red'>This is the subject of the Problems List.<br/>This MUST use the CareConnect patient profile. </font>See [patient resource reference](explore_problems_list.html#patient-reference) for information on how to populate the resource. |
...
|  - encounter | 0..1 | Optional | [Reference](http://hl7.org/fhir/stu3/references.html "Reference") | Context in which list created<br/>Constraint (ref-1): SHALL have a contained resource if a local reference is provided<br/><br/> |
|   |  | Optional | [CareConnect-Encounter-1](https://fhir.hl7.org.uk/STU3/StructureDefinition/CareConnect-Encounter-1 "CareConnect-Encounter-1") | This is the context of the Problems list.<br/> |
|  - - reference | 0..1 | Optional | [String](http://hl7.org/fhir/stu3/datatypes.html#string "String") | Literal reference, Relative, internal or absolute URL |
|  - - identifier | 0..1 | Optional | [Identifier](http://hl7.org/fhir/stu3/datatypes.html#identifier "Identifier") | Logical reference, when literal reference is not known |
|  - - display | 0..1 | Optional | [String](http://hl7.org/fhir/stu3/datatypes.html#string "String") | Text alternative for the resource |
...
|  - entry | 0..* | Optional | [BackboneElement](http://hl7.org/fhir/stu3/backboneelement.html "BackboneElement") | Entries in the list<br/><font color='red'>The entries MUST be as per the diagram for this PRSB headings list with the Condition/Observation resources being the focal resources.</font><br/> |
|  - - date | 0..1 | Required | [dateTime](http://hl7.org/fhir/stu3/datatypes.html#datetime "dateTime") | When item added to list<br/><font color='red'>The SHOULD contain a system time of when the item was added to the list.</font><br/> |
|  - - item | 1..1 | Required | [Reference](http://hl7.org/fhir/stu3/references.html "Reference") | Actual entry<br/>Constraint (ref-1): SHALL have a contained resource if a local reference is provided<br/><font color='red'>A reference to Condition/Observation resource(s) included in the list. This MUST use the CareConnect Condition or Observation profile. </font> |
...
|**View Used FHIR Elements**|**[View All FHIR Elements](explore_problems_list_all.html#mapping-for-problems-list-encounter)**|  
...
|**View Used FHIR Elements**|**[View All FHIR Elements](explore_problems_list_all.html#mapping-for-problems-list-condition)**|  
...
|**View Used FHIR Elements**|**[View All FHIR Elements](explore_problems_list_all.html#mapping-for-problems-list-observation)**| 
