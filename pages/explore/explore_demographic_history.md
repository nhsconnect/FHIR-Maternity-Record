...
|  - - - display | 0..1 | Mandatory | [String](http://hl7.org/fhir/stu3/datatypes.html#string "String") | Representation defined by the system<br/><font color='red'>This MUST contain the value 'Demographic history'</font><br/><font color='red'><b>Mapping to Maternity data item = 'PSRB Heading Demographic history'</b></font>  |
