...
|  - - item | 1..1 | Required | [Reference](http://hl7.org/fhir/stu3/references.html "Reference") | Actual entry<br/>Constraint (ref-1): SHALL have a contained resource if a local reference is provided<br/><font color='red'>A reference to a RelatedPerson resource included in the list<br/>This MUST use the CareConnect RelatedPerson profile. </font><br/>See [RelatedPerson resource](explore_plan_and_requested_actions.html#mapping-for-personal-contacts-relatedperson) for information on how to populate the resource. |
