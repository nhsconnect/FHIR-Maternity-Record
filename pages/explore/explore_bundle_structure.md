...
summary: "The structure of the bundle used for Maternity-Record (Maternity-Record) event messages"
---

## The Maternity-Record Event Message Bundle Structure ##

To enable a standardised structure to carry information regarding event messages within the scope of the Maternity-Record Events specification, the Bundle and the Message Header resources combine to make up the initial event message bundle structure:
...
The root class of the MessageHeader is fulfilled using the 'focus' element in the resource. For Maternity-Record events this will reference the Encounter resource.

## The Maternity-Record Event Message Bundle Structure with Event Header Items ##
...
## The Maternity-Record Event Message Bundle Structure with Maternity-Record Data Items ##
